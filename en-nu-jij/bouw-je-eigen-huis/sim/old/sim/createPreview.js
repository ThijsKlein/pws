function createPreview(floor, type, id, tileSize, position, color) {
    ...
    if (type === 'floor') {
        ...
        function createFloor(position, tileSize, size, color) {
            ...
            for (let i = 1; i < size - 1; i++) {
                for (let j = 1; j < size - 1; j++) {
                    const object = createRedObject(position, tileSize, color);
        ...
        return createFloor(position, tileSize, 10, color);
