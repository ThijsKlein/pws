...
function createFloors(floor, type, id, size, color) {
    ...
    if (type === 'foundations') {
        ...
        function createWall(position, tileSize) {
            ...
            for (let i2 = 0; i2 < 4; i2++) {
                ...
                for (let i = 0; i < size; i++) {
                    ...
                    if (i2 === 0) {
                        ...
                        wall1.kind = materialSelectObject;
                        ...
                        wall2.kind = materialSelectObject;
                    ...
                    if (i2 === 1) {
                        ...
                        object2.kind = materialSelectObject;
            ...
            console.log(wallGroup.kind, 'fjdkfjdskfkjdsljkfds')
                // scene.add(wallGroup);
            ...
            console.log(wallGroup, position, time, materialSelectObject, 'fjdkfjdskfkjdsljkfds');

            animateFall(wallGroup, position, time, materialSelectObject);
    ...
    if (type === 'foundations_Special') {
        ...
        function createWall(position, tileSize) {
            ...
            if (currentMaterial === 'black' && currentFloor > 0 || currentMaterial === 'orange' && currentFloor > 0 || currentMaterial === 'grey' && currentFloor > 0 || currentMaterial === 'cyan' && currentFloor > 0) {
                        ...
                        if (currentMaterial !== 'cyan') {
                            ...
                            if (i === 0) {
                                ...
                                while (i0 < 2) {
                                    ...
                                    wall3.kind = materialSelectObject;
            ...
            wallGroup.floorAttachment = currentFloor;
            wallGroup.kind = materialSelectObject;
            //  scene.add(wallGroup);

            time = 50;

            console.log(materialSelectObject, 'fdjkfjkdjkfdsjfkds');
            animateFall(wallGroup, position, time, materialSelectObject);
