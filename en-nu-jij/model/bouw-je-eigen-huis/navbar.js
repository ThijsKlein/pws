...
function selectSideNav(object) {
    ...
    if (object === 'Wall') {
        ...
        createTextForNav(dataId, object, 6);
    ...
    if (object === 'Floor') {
        ...
        createTextForNav(dataId, object, 8);
...
function changeDiff(number) {
    ...
    if (number === 1) {
        ...
        document.querySelector('#DiffEff').style.color = '#009688';


        const objectsInScene = scene.children;

        currentBalance = 1.2 * startBalance;
        bankManagerInit();
    ...
    if (number === 2) {
        ...
        document.querySelector('#DiffEff').style.color = '#8d8e92';
    ...
    if (number === 3) {
        ...
        document.querySelector('#DiffEff').innerText = '-20% budget'
        document.querySelector('#DiffEff').style.color = '#d32f2f';

        const objectsInScene = scene.children;

        //Reset Balance
        currentBalance = 0.8 * startBalance;
        bankManagerInit();
